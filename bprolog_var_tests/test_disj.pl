...
:- table zero200__1/1.
:- table set_unify/2.
tabled_predicate(prec__1/1).
tabled_predicate(resources__1/1).
tabled_predicate(minaf__1/1).
tabled_predicate(minnf__1/1).
tabled_predicate(maxef__1/1).
tabled_predicate(minsf__1/1).
tabled_predicate(maxnf__1/1).
tabled_predicate(duration__1/2).
tabled_predicate(jobs__1/1).
tabled_predicate(p__1/2).
tabled_predicate(el__1/2).
tabled_predicate(rev__1/3).
tabled_predicate(disj__1/4).
tabled_predicate(disjunct__1/1).
tabled_predicate(ellist__1/3).
tabled_predicate(makedisj2__1/4).
tabled_predicate(makedisj1__1/3).
tabled_predicate(makedisj__1/4).
tabled_predicate(makeminnf__1/2).
tabled_predicate(makeminsf__1/2).
tabled_predicate(makeminaf__1/2).
tabled_predicate(smeqc__1/3).
tabled_predicate(makemaxef__1/2).
tabled_predicate(makemaxnf__1/2).
tabled_predicate(gteqc__1/3).
tabled_predicate(makeprec__1/2).
tabled_predicate(setup__1/3).
tabled_predicate(memberEl__1/3).
tabled_predicate(makevars__1/2).
tabled_predicate(top__1/1).
tabled_predicate(zero200__1/1).
