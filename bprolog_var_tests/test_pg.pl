...
:- table member__1/2.
:- table set_unify/2.
tabled_predicate(pdsbm__1/2).
tabled_predicate(pds__1/2).
tabled_predicate(pds1__1/4).
tabled_predicate(check__1/5).
tabled_predicate(mergedelete__1/3).
tabled_predicate(rev__1/3).
tabled_predicate(dif__1/5).
tabled_predicate(iota1__1/3).
tabled_predicate(iota__1/2).
