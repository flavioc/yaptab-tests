...
:- table play__1/2.
:- table set_unify/2.
tabled_predicate(set_unify/2).
tabled_predicate(pieces__1/1).
tabled_predicate(initialize__1/3).
tabled_predicate(lookahead__1/1).
tabled_predicate(sumlist__1/3).
tabled_predicate(sumlist__1/2).
tabled_predicate(rev__1/3).
tabled_predicate(reverse__1/2).
tabled_predicate(nonzero__1/1).
tabled_predicate(zero__1/1).
tabled_predicate(writekalahs__1/2).
tabled_predicate(writepile__1/1).
tabled_predicate(displayholes__1/1).
tabled_predicate(writestones__1/1).
tabled_predicate(show__1/1).
tabled_predicate(displaygame__1/2).
tabled_predicate(swap__1/2).
tabled_predicate(genlegal__1/1).
tabled_predicate(legal__1/1).
tabled_predicate(nextplayer__1/2).
tabled_predicate(nsubstitute__1/4).
tabled_predicate(nthmember__1/3).
tabled_predicate(announce__1/1).
tabled_predicate(gameover__1/3).
tabled_predicate(value__1/2).
tabled_predicate(distribute__1/3).
tabled_predicate(pickupanddistribute__1/4).
tabled_predicate(distributeyourholes__1/3).
tabled_predicate(updatekalah__1/5).
tabled_predicate(checkiffinished__1/2).
tabled_predicate(checkcapture__1/7).
tabled_predicate(distributemyholes__1/5).
tabled_predicate(distributestones__1/4).
tabled_predicate(move__1/3).
tabled_predicate(extendmove__1/4).
tabled_predicate(stonesinhole__1/3).
tabled_predicate(member__1/2).
tabled_predicate(move__1/2).
tabled_predicate(cutoff__1/9).
tabled_predicate(evaluateandchoose__1/7).
tabled_predicate(allmoves__1/2).
tabled_predicate(alphabeta__1/6).
tabled_predicate(choosemove__1/3).
tabled_predicate(play__1/3).
tabled_predicate(play__1/2).
...
ord_union(ListOfSets, Union) :-
	my_length(ListOfSets, NumberOfSets),
