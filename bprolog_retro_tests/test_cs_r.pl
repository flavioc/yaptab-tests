...
:- table set_unify/2.
tabled_predicate(ground__1/1).
tabled_predicate(quantity__1/1).
tabled_predicate(empty__1/1).
tabled_predicate(cuth__1/1).
tabled_predicate(cutv__1/1).
tabled_predicate(wasteh__1/1).
tabled_predicate(wastev__1/1).
tabled_predicate(vertical__1/1).
tabled_predicate(ground_list__1/1).
tabled_predicate(horizontal__1/1).
tabled_predicate(member__1/2).
tabled_predicate(append__1/3).
tabled_predicate(find__1/3).
tabled_predicate(addliste__1/3).
tabled_predicate(addelement__1/3).
tabled_predicate(construct__1/3).
tabled_predicate(intersection__1/2).
tabled_predicate(split__1/2).
tabled_predicate(allsplit__1/2).
tabled_predicate(split__1/3).
tabled_predicate(genempty__1/2).
tabled_predicate(emptyconfig__1/1).
tabled_predicate(combcutaux__1/6).
tabled_predicate(combcut__1/6).
tabled_predicate(combine__1/4).
tabled_predicate(combination__1/3).
tabled_predicate(nobeter__1/2).
tabled_predicate(nobeter__1/3).
tabled_predicate(generatecut__1/6).
tabled_predicate(generatecutaux__1/9).
tabled_predicate(generatecut__1/9).
tabled_predicate(cut__1/5).
tabled_predicate(gencut__1/4).
tabled_predicate(horizontalcut__1/1).
tabled_predicate(verticalcut__1/1).
tabled_predicate(configuration__1/1).
tabled_predicate(pgenconfig__1/1).
