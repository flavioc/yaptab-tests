...
:- table set_unify/2.
tabled_predicate(member1__1/2).
tabled_predicate(peepelimupd__1/4).
tabled_predicate(peepdel__1/3).
tabled_predicate(apeepelim__1/6).
tabled_predicate(peepelim__1/6).
tabled_predicate(peepredundant__1/6).
tabled_predicate(peepterm__1/2).
tabled_predicate(peepchk__1/2).
tabled_predicate(peepuse__1/2).
tabled_predicate(poptchkmember__1/3).
tabled_predicate(poptmovreg0__1/4).
tabled_predicate(poptmovreg__1/5).
tabled_predicate(notmember1__1/2).
tabled_predicate(compbuiltin__1/3).
tabled_predicate(poptbuiltin__1/4).
tabled_predicate(comppopt4__1/5).
tabled_predicate(poptuni2bld__1/2).
tabled_predicate(comppopt1a__1/2).
tabled_predicate(comppopt1av__1/2).
tabled_predicate(comppopt11__1/3).
tabled_predicate(comppopt1__1/2).
tabled_predicate(comppeepopt__1/3).
