...
:- table main__1/2.
:- table set_unify/2.
tabled_predicate(length__1/3).
tabled_predicate(length__1/2).
tabled_predicate(concat__1/3).
tabled_predicate(my_atom__1/1).
tabled_predicate(match__1/2).
tabled_predicate(p_match__1/2).
tabled_predicate(p_investigate__1/2).
tabled_predicate(my_arg__1/3).
tabled_predicate(my_functor__1/3).
tabled_predicate(property__1/3).
tabled_predicate(get_pats__1/4).
tabled_predicate(get_pats__1/3).
tabled_predicate(investigate__1/2).
tabled_predicate(split__1/4).
tabled_predicate(randomize__1/3).
tabled_predicate(fill__1/3).
tabled_predicate(test__1/3).
tabled_predicate(init__1/6).
tabled_predicate(init__1/5).
tabled_predicate(main__1/2).
